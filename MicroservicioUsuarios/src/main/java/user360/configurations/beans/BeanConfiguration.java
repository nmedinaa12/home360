package user360.configurations.beans;

import user360.application.mappers.UserDtoMapper;
import user360.application.services.UserService;
import user360.application.services.impl.UserServiceImpl;
import user360.domain.ports.in.UserServicePort;
import user360.domain.ports.out.PasswordEncoderPort;
import user360.domain.ports.out.UserPersistencePort;
import user360.domain.usecases.UserUseCase;
import user360.infrastructure.adapters.persistence.UserPersistenceAdapter;
import user360.infrastructure.adapters.security.BCryptPasswordEncoderAdapter;
